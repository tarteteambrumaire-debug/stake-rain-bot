...
const TELEGRAM_TOKEN  = '8736690342:AAFu1whZ7SeE072sM42adY_DcRS296mVQn4'; // @StakePulseAlert_Bot — commandes /register
const NOTIFY_TOKEN    = '8363491801:AAFnrD_Gx4ZHtgPA6glsJicLwGWcDu0DF9w';  // @RainActual_Bot — notifs perso
...
// ─── Telegram ─────────────────────────────────────────────────────────────────
function sendMessage(chatId, text, useNotifyBot = false) {
  return new Promise((resolve, reject) => {
    const token = useNotifyBot ? NOTIFY_TOKEN : TELEGRAM_TOKEN;
